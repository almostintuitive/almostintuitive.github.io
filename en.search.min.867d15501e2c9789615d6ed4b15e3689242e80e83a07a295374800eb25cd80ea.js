...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6d48cd5913c562abadf58674d0ffc1a4725107518b84184a0eb6cbc79ca43958.js',function(){input.required=false;search();});}
